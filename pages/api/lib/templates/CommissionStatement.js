export const TemplateCommissionStatement = ({ username, id }) => {
    ...
    <tr>
    <td>
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #cb1d6c; color: #000000; width: 700px;" width="700">
    <tbody>
    <tr>
