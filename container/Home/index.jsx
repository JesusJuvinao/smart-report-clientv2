...
export const IndexC = () => {
  return (
    <Container>
      ...
      <Hero />
      <HeroCard />
      <OnBanner height='18.25rem' title='Ready to run your business better with Smart-report Online?' color={BGColor} bgColor={SECColor} width='220px' size='2.125rem' Button TextBtn='Buy now and save' />
      <TabList />
      <PricingCard />
      <Modules />
      <PQR />
      <Item />
      <OnBanner height='18.25rem' title='See what Smart-report can do for your business.' color={BGColor} bgColor={SECColor} width='220px' size='2.125rem' Button TextBtn='Buy now' />
    </Container>
